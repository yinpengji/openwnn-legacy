...
public class UserDictionaryToolsListJAJP extends UserDictionaryToolsList {
    ...
    public UserDictionaryToolsListJAJP() {
        mListViewName = "com.googlecode.openwnn.legacy.JAJP.UserDictionaryToolsListJAJP";
        mEditViewName = "com.googlecode.openwnn.legacy.JAJP.UserDictionaryToolsEditJAJP";

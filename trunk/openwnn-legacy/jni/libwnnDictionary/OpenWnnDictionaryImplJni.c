 ...
 */
#include "OpenWnnDictionaryImplJni.h"
...
/*
 * Class:     com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni
 * Method:    createWnnWork
 * Signature: (Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_createWnnWork
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_freeWnnWork
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_clearDictionaryParameters
  (JNIEnv *env, jobject obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (JIII)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setDictionaryParameter
 ...
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_searchWord
  (JNIEnv *env, jobject obj, jlong wnnWork, jint operation, jint order, jstring keyString)
{
	NJ_JNIWORK*	work;

	if( !( operation == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_SEARCH_EXACT ||
           operation == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_SEARCH_PREFIX ||
           operation == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_SEARCH_LINK ) ||
		!( order == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_ORDER_BY_FREQUENCY ||
           order == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_ORDER_BY_KEY ) ||
		   keyString == NULL ) {
		/* If a invalid parameter was specified, return an error code */
	...
	if( work != NULL ) {
		...
		if( convertStringToNjChar( env, work->keyString, keyString, NJ_MAX_LEN ) >= 0 ) {
            ...
            if( operation == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_SEARCH_LINK ) {
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getNextWord
 ...
 */
JNIEXPORT jstring JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getStroke
  (JNIEnv *env, jobject obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getCandidate
  (JNIEnv *env, jobject obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getFrequency
  (JNIEnv *env, jobject obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_clearApproxPatterns
  (JNIEnv *env, jobject obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setApproxPattern__JLjava_lang_String_2Ljava_lang_String_2
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setApproxPattern__JI
  (JNIEnv *env, jclass obj, jlong wnnWork, jint approxPattern)
{
	NJ_JNIWORK	*work;

	if( !( approxPattern == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_TOUPPER ||
		   approxPattern == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_TOLOWER ||
		   approxPattern == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_QWERTY_NEAR ||
		   approxPattern == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_QWERTY_NEAR_UPPER ||
		   approxPattern == com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_APPROX_PATTERN_JAJP_12KEY_NORMAL ) ) {
		/* If a invalid parameter was specified, return an error code */
		return NJ_SET_ERR_VAL(NJ_FUNC_JNI_SET_APPROX_PATTERN, NJ_ERR_INVALID_PARAM);
	}
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getLeftPartOfSpeech
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getRightPartOfSpeech
  (JNIEnv *env, jclass obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_clearResult
  (JNIEnv *env, jclass obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setLeftPartOfSpeech
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setRightPartOfSpeech
 ...
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setStroke
 ...
 * Signature: (JLjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_setCandidate
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_selectWord
  (JNIEnv *env, jclass obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getLeftPartOfSpeechSpecifiedType
  (JNIEnv *env, jclass obj, jlong wnnWork, jint type)
{
	...
	if( work != NULL ) {
        switch( type ) {
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_V1:
            type = NJ_HINSI_V1_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_V2:
            type = NJ_HINSI_V2_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_V3:
            type = NJ_HINSI_V3_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_BUNTOU:
    		/* No part of speech is defined at this type */
            return 0;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_TANKANJI:
            type = NJ_HINSI_TANKANJI_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_SUUJI:
    		/* No part of speech is defined at this type */
            return 0;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_MEISI:
            type = NJ_HINSI_MEISI_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_JINMEI:
            type = NJ_HINSI_JINMEI_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_CHIMEI:
            type = NJ_HINSI_CHIMEI_F;
            break;
        case com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_POS_TYPE_KIGOU:
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getRightPartOfSpeechSpecifiedType
  (JNIEnv *env, jclass obj, jlong wnnWork, jint type)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (JI)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getConnectArray
  (JNIEnv *env, jclass obj, jlong wnnWork, jint leftPartOfSpeech)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getNumberOfLeftPOS
  (JNIEnv *env, jclass obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getNumberOfRightPOS
  (JNIEnv *env, jclass obj, jlong wnnWork)
{
	NJ_JNIWORK*	work;
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_getApproxPattern
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_createBindArray
 ...
 */
JNIEXPORT jstring JNICALL Java_com_googlecode_openwnn_legacy_OpenWnnDictionaryImplJni_createQueryStringBase
